...
> 以下为精选模型，完整列表见 [`models.json`](./models.json)，Web UI 可实时拉取 NIM 平台全部模型。
...
| GLM-5.1 | 旗舰 agentic 编码 & 长程推理 |
| Gemma 4 31B | Dense 31B, 前沿推理 & 编码 |
| Llama 4 Maverick | 128-expert MoE, 17B active, 多模态 |
| Llama 3.3 70B | 通用稳定, 指令跟随强 |
| Nemotron 3 Super 120B | Mamba-Transformer MoE, 1M ctx, agentic |
| Mistral Large | 旗舰编码 & 多语言 |
| Nemotron 70B | NVIDIA 调优, 编码 & tool calling |
| Nemotron Nano 12B VL | 多模态, 视频理解 & 文档智能 |
| Phi-4 | 14B, 小巧强推理 |
| Qwen3.5 122B | 快速通用, ~110 tok/s |
| Step 3.5 Flash | 200B MoE, frontier agentic |
| Llama 3.1 405B | 最大稠密模型, 强指令跟随 |
| 等 26 个模型... | 详见 [`models.json`](./models.json) 或 Web UI |
